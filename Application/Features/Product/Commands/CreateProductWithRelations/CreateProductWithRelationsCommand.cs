...
{
    public class CreateProductWithRelationsCommand : IRequest<string>
    {
        #region Product 
        ...
        public double ProductDeliverPrice { get; set; }
        ...
        public byte ProductJeldPrintSide { get; set; }
        public string ProductJeldFileExtension { get; set; } = null!;
        public bool ProductJeldIsCmyk { get; set; }
        public double? ProductJeldCutMargin { get; set; }
        public double? ProductJeldPrintMargin { get; set; }
        public bool ProductJeldIsCheckFile { get; set; }
